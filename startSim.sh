...
LD_LIBRARY_PATH=/home/nekokitty/dev/freeglut-3.2.1/build/lib/:/usr/local/lib/:/usr/include/openmpi-x86_64/:/usr/lib64/
export LD_LIBRARY_PATH

#ipython3 --pdb DeepMimic.py -- --arg_file $1
#nohup ipython3 --pdb DeepMimic.py -- --arg_file $1 & tail nohup.out
ipython3 --pdb MGSim.py -- --arg_file args/play_motion_dog3d_args.txt
